...
func parseMessage(message string) (parsedMessage *util.TMessage) {
	...
	*/
	...
	if strings.HasPrefix(message, "@") {
		...
		util.Config.Log.Debugln("messageSplit0-4: ", messageSplit[0]+messageSplit[1]+messageSplit[2]+messageSplit[3]+messageSplit[4])
		rawMessageText := strings.TrimLeft(message, messageSplit[0]+messageSplit[1]+messageSplit[2]+messageSplit[3]+messageSplit[4])
